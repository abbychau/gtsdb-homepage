    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <article className="prose prose-gray prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
          ...
          <div className="not-prose my-6 mx-auto max-w-xl rounded-lg border border-slate-200 bg-slate-50/80 p-4 text-sm shadow-sm">
            
            <ul className="space-y-1 text-slate-600">
              <li><strong className="text-slate-700">Workload:</strong> 8 concurrent TCP pipelines &times; 50 keys, 30s continuous write+read</li>
              <li><strong className="text-slate-700">Operations:</strong> 11,347,800 writes + 5,687 reads in 30s (~378K writes/sec)</li>
              <li className="flex items-center gap-1.5">
                <svg className="h-3.5 w-3.5 text-slate-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg>
                <a href="https://github.com/abbychau/gtsdb/blob/main/benchmark/memory_bench.go" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline underline-offset-2">
                  github.com/abbychau/gtsdb/blob/main/benchmark/memory_bench.go
                </a>
              </li>
            </ul>
          </div>
